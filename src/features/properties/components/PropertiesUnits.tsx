...
import { Plus, Trash2, Edit2, Building, Shield, Settings2, Clock, BedDouble, Bath } from "lucide-react"
...
export function PropertiesUnits() {
    ...
    useEffect(() => {
        catalogService.getRoomTypes().then(list => {
            if (list.length > 0) setRoomTypes(list)
        })
    }, [])
                        ...
                        <DialogContent className="sm:max-w-[700px] h-[90vh] flex flex-col p-0">
                            ...
                            <ScrollArea className="flex-1 p-6 pt-0">
                                <Tabs defaultValue="basic" className="space-y-4">
                                    <TabsList className="grid grid-cols-4 w-full h-9 p-1 bg-slate-100 rounded-lg">
                                        <TabsTrigger value="basic" className="text-[10px] font-bold uppercase">Básico</TabsTrigger>
                                        <TabsTrigger value="amenities" className="text-[10px] font-bold uppercase">Estadía</TabsTrigger>
                                        <TabsTrigger value="rooms" className="text-[10px] font-bold uppercase">Muebles</TabsTrigger>
                                        <TabsTrigger value="policies" className="text-[10px] font-bold uppercase">Políticas</TabsTrigger>
                                    </TabsList>
                                    ...
                                    <TabsContent value="basic" className="space-y-4">
                                        <div className="flex items-center justify-between p-3 bg-muted/20 rounded-lg border">
                                            ...
                                            <Switch
                                                checked={unitForm.status_record_id === 1}
                                                onCheckedChange={(checked) => setUnitForm({ ...unitForm, status_record_id: checked ? 1 : 2 })}
                                            />
                                        </div>
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            ...
                                            <div className="grid gap-2">
                                                <Label htmlFor="internal_name">Nombre Interno (Code)</Label>
                                                <Input
                                                    id="internal_name"
                                                    placeholder="SJ-101"
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            ...
                                            <div className="grid gap-2">
                                                <Label htmlFor="contact_name">Contacto de Emergencia</Label>
                                                <Input
                                                    id="contact_name"
                                                ...
                                                <div className="grid grid-cols-2 gap-3">
                                                    ...
                                                    <div className="space-y-1">
                                                        ...
                                                        >
                                                            ...
                                                            <SelectContent>
                                                                <SelectItem value="SINGLE">Sencilla</SelectItem>
                            ...
                            fields.map((field: any, index) => (
                                <TableRow key={field.id}>
                                    ...
                                    <TableCell className="text-xs text-slate-500">
                                        {field.room_type_id === 1 ? 'Alojamiento Entero' :
                                            field.room_type_id === 2 ? 'Habitación Privada' : 'Compartido'}
                                    </TableCell>
                                    <TableCell className="text-sm">
                                        {field.extra?.max_occupancy || 0} {(field.extra?.max_occupancy || 0) === 1 ? 'Huésped' : 'Huéspedes'}
                                    </TableCell>
                                    <TableCell>
                                        <div className={cn(
                                            "inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider",
                                            field.status_record_id === 1
                                                ? "bg-emerald-50 text-emerald-600 border border-emerald-100"
                                                : "bg-slate-100 text-slate-500 border border-slate-200"
                                        )}>
                                            {field.status_record_id === 1 ? "Activo" : "Inactivo"}
                                        </div>
                                    </TableCell>
                                    <TableCell className="text-right font-semibold">
                                        ${field.price?.toLocaleString() || '0'}
                                    </TableCell>
